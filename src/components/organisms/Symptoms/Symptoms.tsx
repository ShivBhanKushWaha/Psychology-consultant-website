        ...
        <div className="bg-[#F8F5FC] py-16 sm:px-16 px-2">
            <div className="flex flex-col">
                ...
                <div className="flex sm:flex-row flex-col justify-between items-center xl:mx-52 lg:mx-12 sm:mx-4 sm:mt-12">
                    <p className="text-[#6F42C1] text-xl sm:w-[60%] w-full px-4 sm:px-0 mt-5 sm:mt-0 text-center sm:text-start">Stay at home and chat with your doctor: <span className="text-[#808081]"> Amet minim mollit non deserunt ullamest sit aliqua dolor do amet sint.</span></p>
